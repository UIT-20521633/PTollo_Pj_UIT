...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center h-screen font-sora  bg-cover bg-center bg-no-repeat  from-purple-900 to-purple-700 text-white" style={{ backgroundImage: `url(${Cards1})` }}>
      <div className="w-96 p-8 bg-white/10 backdrop-blur-md rounded-xl shadow-lg">
        ...
        <p className="text-center text-white mt-4">
          Don't have an account? <a href="#" className="text-cyan-300 hover:underline">Sign up</a>
        </p>
        ...
        <div className="flex items-center my-6">
          ...
          <button
            className="text-14 w-full flex items-center justify-center py-2 border border-white rounded-md hover:bg-white hover:text-black transition"
          >
